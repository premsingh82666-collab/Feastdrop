...
const API = "https://feastdrop-production.up.railway.app/api";
 ...
 const restaurants = [
  ...
  { id:3, name:"Bombay street", cuisine:"Indian", rating:4.9, deliveryTime:"30-45 min", deliveryFee:3.49, image:"🍢", bg:"#FFCC80", menu:[{id:301,name:"masala dosa",desc:"South indian special",price:129,emoji:"🥞"},{id:302,name:"Chole Bhature",desc:"Punjabi delight",price:179,emoji:"🥘"},{id:303,name:"Samosa",desc:"Crispy snack",price:29,emoji:"🥟"},{id:304,name:"Gulab Jamun",desc:"Indian dessert",price:59,emoji:"🍮"}]},
